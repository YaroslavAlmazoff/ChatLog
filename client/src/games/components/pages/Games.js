        ...
        <div className="games-overlay">
            <div className="games block">
                <div style={{width: '100%'}}>
                    ...
                    <img className="games-img" src={require('../../img/games-img.png')} alt="" />
                </div>
                <div className="games-games">
                {
                    searchedGames.map(item => <GameItem item={item} />)
                }
                {auth.userId == '628e5aab0153706a3e18fe79' && <div className="game-item" onClick={gotoCreate}>
