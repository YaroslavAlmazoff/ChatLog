...
const UserVideoMobile = ({
  ...
  return (
    <div
      onMouseOver={() => updateLikers()}
      onMouseLeave={() => setLikersDisplay("none")}
      onClick={() => openPost(obj)}
      className="article-video-mobile"
    >
      <div className="info-mobile-mobile">
        {isOwner ? (
          <p
            onClick={
              imageUrl.split(".")[1] !== "mp4"
                ? (e) => deletePost(e, obj.id, setUserPosts, userPosts)
                : (e) => deleteVideo(e, obj.id, setUserVideos, userVideos)
            }
            className={
              imageUrl.split(".")[1] !== "mp4"
        ...
        <div className="l_and_c-mobile">
          <p>
            <img onClick={(e) => mark(e)} width="30" src={like} alt="like" />
            {likesCount}
          </p>
          <p>
            <img
              onClick={(e) => comm(e, obj)}
              width="26"
              src={commentIcon}
              alt="comment"
            />
