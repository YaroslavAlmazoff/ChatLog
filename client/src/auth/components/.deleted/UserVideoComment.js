...
const UserVideoComment = ({
  ...
  return (
    <div className="comment-foto">
      {user === auth.userId ? (
        <p className="delete-comment" onClick={() => deleteComment(id)}>
          &times;
        </p>
      ) : (
        <></>
      ...
      <div className="comment-head">
        <div className="user-info">
          <img
            ...
            alt="user"
          />
          <p onClick={gotoCommenter} className="comment-user-name">
            {commenter.name} {commenter.surname}
          </p>
        </div>
