...
const Fotography = () => {
    ...
    return (
        <div className="dark-wrapper" style={foto.imageUrl === 'user.png' ? {backgroundColor: 'rgb(20, 20, 32)'} : {backgroundColor: 'rgb(41, 41, 41)'}}>
            {foto.imageUrl === 'user.png' ? <Loader ml={'0%'} />
            :
            <>{!loading ? <div className="window" style={foto.imageUrl === 'user.png' ? {backgroundColor: 'rgb(20, 20, 32)'} : {backgroundColor: 'white'}}>
