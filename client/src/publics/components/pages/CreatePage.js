...
const CreatePage = () => {
    ...
    const createPublic = async () => {
        ...
        const response = await api.post(`/api/public/create`, formData, {headers: 
        ...
        <div className="create-public">
            {!loading ? <div className="create-public-form">
                ...
                <div className='create-public-upload-field'>
                    ...
                    <ImagePreview imageUrl={imagePreviewUrl1} imageDisplay={imagePreviewDisplay1} />
                </div>
                <div className='create-public-upload-field'>
                    <button onClick={(e) => emitOpen2(e)} className='create-public-button'>Выберите баннер</button>
                    <ImagePreview imageUrl={imagePreviewUrl2} imageDisplay={imagePreviewDisplay2} />
                </div>
