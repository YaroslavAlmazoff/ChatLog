...
function AboutAuthor() {
  return (
    ...
    >
      ...
      <span className="art-aboutAuthor-text">
        Опыт в создании картин более 10 лет. За это время было продано более 170
        эксклюзивных художественных работ.
      </span>
      <span className="art-aboutAuthor-text">
      ...
      <span className="art-aboutAuthor-text" style={{ marginTop: "40px" }}>
        ...
        <br />
        Грунтованный холст на прочном деревянном подрамнике исключает провисание
        холста и любую деформацию.
        <br />
