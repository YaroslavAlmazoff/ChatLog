...
const UpdateProduct = () => {
    ...
    useEffect(() => {
        ...
        const getProduct = async () => {
            const response = await api.get('/api/store/product/:id')
            setName(response.data.product.name)
            setDesctiption(response.data.product.description)
    ...
    const send = async () => {
        ...
        const response = await api.post(`/api/store/updateproduct/${params.id}`, auth, formData)
