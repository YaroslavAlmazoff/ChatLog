          ...
          <div className="links">
            {auth.isAuthenticated ? (
              <div className="links">
                ...
                <button
                  ref={linkRef8}
                  onClick={() => visit(linkRef8, `/user/${auth.userId}`)}
                  className="link"
                >
                  Мой профиль
                </button>
                <button
                  ref={linkRef4}
                  onClick={() => visit(linkRef4, "/messages")}
                  className="link"
                >
                  Сообщения
                </button>
                ...
                <button
                  ref={linkRef10}
                  onClick={() => visit(linkRef10, "/settings")}
                  className="link"
                  exact="true"
                >
                  Настройки
              ...
              <div>
                ...
                <button
                  ref={linkRef6}
                  onClick={() => visit(linkRef6, "/register")}
                  className="link"
                >
                  Регистрация
                </button>
