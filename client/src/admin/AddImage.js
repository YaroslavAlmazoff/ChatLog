...
const AddImage = () => {
    ...
    return (
        <div className="form block">
            ...
            <input className="input" type="text" value={text} onChange={(e) => setText(e.target.value)} placeholder="папка" />
            <input className="input" type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="имя файла" />
            <input onChange={(e) => getFile2(e)} ref={fileRef} type="file" />
            <button onClick={(e) => emitOpen2(e)} className="button">Добавить фотографию</button>
