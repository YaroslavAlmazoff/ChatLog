...
class ChatRoomService {
    ...
    async sendMessage(req, res) {
        ...
        await Message.create({
            message, name: USER.name, avatarUrl: USER.avatarUrl, date, user, room, isNotReaded: false, isFile, imageUrl: filename, videoUrl: videofilename, readedThisMessage: [user]
        }).then(() => {
    ...
    async editMessage(req, res) {
        await Message.findByIdAndUpdate(req.params.id, {message: req.body.message})
